...
public class InUploadListAdapter extends BaseAdapter {

    private List<InRegister> list;
    private Context context;

    public InUploadListAdapter(Context context, List<InRegister> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.adapter_in_upload, null);
...
//        holder.tvLocation.setText(list.get(position).getCKAbbName());//存放地址
    ...
    class ViewHolder {
        TextView tvSupper, tvBarcode, tvQuantity;//, tvLocation;
