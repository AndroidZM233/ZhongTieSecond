package com.speedata.updateversion;
    ...
    public class CheckVersionTask implements Runnable {
        ...
        public void run() {
            try {
                ...
                String path = "http://" + app.getSharedPreferences().getString(Constant
                        .FIELD_UPDATE_IP, Constant.FIELD_UPDATE_IP_DEFAUT) + "/speedataApps/zhongtie_version.xml";
                ...
                public void run() {
                    try {
                        File file = DownLoadManager.getFileFromServer(
                                info.getUrl(), pd, "ZhongtieSecond.apk");
