...
public class AllotAgainBarCodeAdapter extends BaseAdapter {

    private List<AllotRecord> list;
    private Context context;
    public static Map<Integer,Boolean>isSelected;

    public AllotAgainBarCodeAdapter(Context context, List<AllotRecord> list) {
