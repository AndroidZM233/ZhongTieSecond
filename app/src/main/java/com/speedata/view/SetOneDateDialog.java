...
public class SetOneDateDialog extends Dialog implements View.OnClickListener {
    ...
    public SetOneDateDialog(Context context, ShowDate showDate, String initialDate) {
