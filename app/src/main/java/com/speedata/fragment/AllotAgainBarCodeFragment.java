 ...
 */
public class AllotAgainBarCodeFragment extends BaseFragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v == tvTime) {
            ...
            allotRecordList = allotRegisterDao
                    .imRawQuery("select * from allotRecord where ProjectID=\"" + mActivity.app
            ...
            allotAgainBarCodeAdapter = new AllotAgainBarCodeAdapter(mActivity, allotRecordList);
            ...
            for (int i = 0; i <allotRecordList.size() ; i++) {
                if (AllotAgainBarCodeAdapter.isSelected.get(i)){
                    ...
                    String infoUnit=allotRecordList.get(i).getInfoUnit();
